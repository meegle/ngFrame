define(function () {
    ...
    .directive('chinaAreaSelector', ['$templateCache', function ($templateCache) {
        return {
            restrict: 'E',
            templateUrl: 'theme/widget/china-area-selector.html',
            // replace: true,
            scope: {
                region: '='
            },
            link: function (scope, element) {
                ...
                var showRegion = function (region) {
                    region = angular.fromJson(region);
                    ...
                    setTimeout(function () {
                        ...
                        $city.children('select').val(cityIndex > -1 ? cityIndex : '');

                        var areaIndex = indexOf(scope.areas, scope.region.area);
                        $area.children('select').val(areaIndex > -1 ? areaIndex : '');
                    });
                };
    ...
    .directive('chinaAreaSelectorWithWrapper', ['$templateCache', function ($templateCache) {
        return {
            restrict: 'E',
            templateUrl: 'theme/widget/china-area-selector-with-wrapper.html',
            // replace: true,
            scope: {
                region: '='
            },
